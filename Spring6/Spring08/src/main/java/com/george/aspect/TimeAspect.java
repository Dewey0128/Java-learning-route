...
public class TimeAspect {   //切面
    ...
    * */
    ...
    @Pointcut("execution(* com.george..*(..)) " +
            "&& !execution(* com.george.service.impl.OrderServiceImpl.generate(..)) " +
            "&& !execution(* com.george.service.impl.OrderServiceImpl.modify(..))")
    public void detailAdvice() {}

    // 切点2：只要modify方法
    @Pointcut("execution(* com.george..*(..)) " +
            "&& !execution(* com.george.service.impl.OrderServiceImpl.generate(..)) " +
            "&& !execution(* com.george.service.impl.OrderServiceImpl.detail(..))")
